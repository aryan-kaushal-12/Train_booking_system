...
void bookTicket(Passenger *passenger,int fare[6][3]) {
    ...
    stationa:
    printf("\tBoarding From sation(1/2/4/5)\t\t:\t");
    scanf(" %d",&passenger->a1);
    if(passenger->train[0]=='A'){
      if(passenger->a1!=1&&passenger->a1!=2){
        printf("Wrong Input Enter Again\n");
        goto stationa;
      }
    }
    else if(passenger->train[0]=='B'){
      if(passenger->a1!=4&&passenger->a1!=5){
        printf("Wrong Input Enter Again\n");
        goto stationa;
      }
    }
    stationb:
    printf("\tTo station(2/3/5/6)\t\t\t:\t");
     scanf(" %d",&passenger->b1);
     if(passenger->train[0]=='A'){
      if(passenger->b1!=2&&passenger->b1!=3){
        printf("Wrong Input Enter Again\n");
        goto stationb;
      }
    }
    else if(passenger->train[0]=='B'){
      if(passenger->b1!=5&&passenger->b1!=6){
        printf("Wrong Input Enter Again\n");
        goto stationb;
      }
    }
...
void cancelTicket(Passenger *passengers, int numPassengers, int pnr) {
...
int main() {
   ...
   Fare();
    ...
    switch(ch)
    {
        ...
        int *kkk=realloc(passengers,newPassengers*sizeof(Passenger));
   ...
   printf("\n\t\tENTER YOUR MOBILE NUMBER\n");
    ...
    int pnrToCancel;
    scanf(" %d", &pnrToCancel);
    cancelTicket(passengers, numPassengers, pnrToCancel);
